function wui.showUnvisitedRooms(area)
  ...
  table.sort(wui.knownRooms)
  for k,v in spairs(roomTable) do
    local roomId = v
    if not wui.knownRooms[roomId] then
  ...
  cechoLink("<firebrick>hightlight ", [[wui.highlightUnvisitedRooms(]]..area..[[)]], "", true)
  cecho("<lime_green>or ")
  cechoLink("<light_blue>unhighlight ", [[wui.highlightUnvisitedRooms(]]..area..[[,"unhighlight")]], "", true)
